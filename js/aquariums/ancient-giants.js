...
class Futabasaurus extends Creature {
  constructor() {
    ...
    super({ species: 'futabasaurus', mesh, position: new THREE.Vector3(-42, 3, -20), cfg: { speed: 1.45, maxAccel: 1.35, turnRate: 1.2, depthMin: -14, depthMax: 16, wallMargin: 12, bounds: GIANT_TANK } });
  }
}
...
class Opabinia extends Creature {
  constructor() {
    ...
    super({ species: 'opabinia', mesh, position: new THREE.Vector3(24, 2.2, -26), cfg: { speed: 2.25, maxAccel: 2.1, turnRate: 2.8, depthMin: -10, depthMax: 18, wallMargin: 10, bounds: GIANT_TANK } });
  }
}
...
class Anomalocaris extends Creature {
  constructor() {
    ...
    mesh.add(armL, armR);
    super({ species: 'anomalocaris', mesh, position: new THREE.Vector3(34, -5, 28), cfg: { speed: 2.05, maxAccel: 2.0, turnRate: 2.4, depthMin: -16, depthMax: 10, wallMargin: 10, bounds: GIANT_TANK } });
  }
}
...
class Cameroceras extends Creature {
  constructor() {
    ...
    super({ species: 'cameroceras', mesh, position: new THREE.Vector3(-26, -4, 34), cfg: { speed: 1.3, maxAccel: 1.1, turnRate: 1.15, depthMin: -18, depthMax: 8, wallMargin: 14, bounds: GIANT_TANK } });
  }
}
...
export function launch() {
  ...
  const camera = new THREE.PerspectiveCamera(72, window.innerWidth / window.innerHeight, 0.1, 460); camera.position.set(0, 14, 148);
  ...
  scene.fog = new THREE.FogExp2(0x031728, 0.015);
